...
export default function AuthCallback() {
  ...
  if (stage === "role_selection") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-pink-50 to-blue-50">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full p-6 rounded-xl border-2 border-gray-200 hover:border-sky-500 hover:bg-sky-50 transition-all group text-left"
              >
                <div className="flex items-center gap-4">
  ...
  if (stage === "doctor_upload") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-sky-50 to-pink-50">
        <div className="max-w-lg w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl p-8">
