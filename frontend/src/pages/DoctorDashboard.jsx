  ...
  useEffect(() => {
    ...
    const autoDetectDoctor = async () => {
      ...
      try {
        ...
        console.log("⏳ Doctor: Starting queries in 500ms...");
    ...
    <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {selected ? (
                ...
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    {(selected.delivery_status === 'delivered' || selected.active_system === 'santanraksha') && (
                      <span className="bg-sky-100 text-sky-700 px-3 py-1 rounded-full text-xs font-bold border border-sky-200 uppercase tracking-wide">
                        Delivered
                      </span>
                    )}
                  </div>
            ...
            <div className="flex-1 overflow-hidden flex gap-6 p-6">
              ...
              <div className="flex-1 bg-white/60 backdrop-blur-xl rounded-xl shadow-md border border-blue-200/40 overflow-hidden flex flex-col">
                {activeTab === "history" ? (
                                ...
                                {isConsultation && a.event_data && (
                                  <div className="mt-3 space-y-3 border-t border-blue-200/40 pt-2">
                                    ...
                                    {a.event_data.medications && a.event_data.medications.length > 0 && (
                                      <div className="bg-sky-50 p-2 rounded text-xs">
                                        <p className="font-bold text-sky-800 mb-1 flex items-center gap-1">💊 Medications</p>
                                        <ul className="space-y-1">
                                          {a.event_data.medications.map((m, i) => (
                                            <li key={i} className="flex justify-between border-b border-sky-100 last:border-0 pb-1">
                                              <span className="font-medium text-slate-600">{m.name || m}</span>
                                              {typeof m === 'object' && (
                  ...
                  <>
                    <div className="bg-gradient-to-r from-sky-600 to-sky-700 text-slate-800 px-6 py-4">
                      <h3 className="text-lg font-bold flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto p-8 bg-gradient-to-br from-sky-50 to-pink-50">
            <DeliveryForm
              doctorId={doctorId}
              onSuccess={(result) => {
